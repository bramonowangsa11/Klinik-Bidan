            ...
            {{-- kiri --}}
                <div class="">
                    ...
                    <div class="mb-3 form-outline border-0 border-bottom border-dark" id="result">
                        ...
                        <input type="text" class="form-control" id="nikSuami" aria-describedby="" name="nikSuami">
                        {{-- <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div> --}}
                    </div>
                    <a href="#" type="submit" class="btn btn-success mb-md-3 position-relative mt-auto mb">Tambah</a>
