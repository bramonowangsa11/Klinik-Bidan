                        ...
                        <div class="card-body row">
                            ...
                            <div class=" icon col-md-auto text-white">
                                <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor"
                                    class="bi bi-calendar-check bg-primary" viewBox="0 0 16 16">
                                    <path
                ...
                <div class="col-md-4">
                    <div class="card card-custom mb-4 rounded-4" style="background-color: #0eb59c">
                        <div class="card-body text-white row">
                            ...
                            <div class=" col-md-auto">
                                <?xml version="1.0" ?><svg id="Icons_FamilyWithTwoChildren" overflow="hidden"
                                    fill="currentColor" version="1.1" width="100" height="100"
