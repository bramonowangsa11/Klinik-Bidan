    ...
    <div class="content flex-grow-1 p-3">
        ...
        <div class="container">
            <div class="row col-md-12">
                {{-- Atas --}}
                <div class="mt-lg-3">
                    <div class="row col-5 bg-danger">
                        <div class="row mb-2">
                            <div class="col-4 col-md-4 font-weight-bold">Tanggal</div>
                            <div class="col-8 col-md-8">: {{$kb->tgl_kb}}</div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-4 col-md-4 font-weight-bold">Nama Istri</div>
                            <div class="col-8 col-md-8">: {{$kb->Ibu->name}}</div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-4 col-md-4 font-weight-bold">NIK Ibu</div>
                            <div class="col-8 col-md-8">: {{$kb->Ibu->nik}}</div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-4 col-md-4 font-weight-bold">Nama Suami</div>
                            <div class="col-8 col-md-8">: {{$kb->Suami->name}}</div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-4 col-md-4 font-weight-bold">NIK Suami</div>
                ...
                {{-- bawah --}}
                <div class=" col-md-9 bg-black col-5 p-0">
                    {{-- buat membungkus tabel --}}
                    <div class=" overflow-x-scroll col-5 col-md-9">
                    ...
                    <div class=" mb-3 mt-3 col-md-6 bg-primary">
                        <div class="row">
                            <div class="col-md-2">
