                    ...
                    <div class=" card-body">
                        <form action="/pasien" method="POST">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="text" class="form-control" id="nama" placeholder="" name="name" value="">
                            </div>
                            <div class="mb-2">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="date" class="form-control" id="tanggal-lahir" placeholder="dd/mm/yyyy" name="ttl" value="">
                            </div>
                            <div class="mb-2">
                                <label for="no-telp" class="form-label">No Telepon</label>
                                <input type="text" class="form-control" id="no-telp" placeholder="" name="no_telp" value="">
                            </div>
