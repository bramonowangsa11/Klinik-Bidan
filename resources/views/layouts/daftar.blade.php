...
@section('content')
<section class="vh-100" style="background:url({{asset('images/group3.jpg')}}); background-repeat:no-repeat; background-size: cover">
                ...
                <form class="mx-1 mx-md-4 mt-0" method="POST" action="/daftar">
                  ...
                  <div class="d-flex flex-row align-items-center mb-2">
                    ...
                    <div class="form-outline border-bottom border-dark flex-fill mb-0">
                        ...
                        <input type="text" id="form3Example3c" class="form-control" name="nik" value="{{old('nik')}}" />
                    </div>
                  </div>
                  {{-- ALamat --}}
                  <div class="d-flex flex-row align-items-center mb-2">
                    ...
                    <div class="form-outline border-bottom border-dark flex-fill mb-0">
                        ...
                        <input type="text" id="form3Example4c" class="form-control" name="alamat" value="{{old('alamat')}}"/>
                    </div>
                  </div>
                  {{-- Tanggal Lahir --}}
                  <div class="d-flex flex-row align-items-center mb-2">
                    ...
                    <div class="form-outline border-bottom border-dark flex-fill mb-0">
                        ...
                        <input type="date" id="form3Example4cd" class="form-control" name="ttl" value="{{old('ttl')}}" />
                    </div>
                  </div>
                  {{-- Nomor Telepon --}}
                  <div class="d-flex flex-row align-items-center mb-2">
                    ...
                    <div class="form-outline border-bottom border-dark flex-fill mb-0">
                        ...
                        <input type="text" id="form3Example5cd" class="form-control" name="no_telp" value="{{old('no_telp')}}"/>
                    </div>
                  </div>
                  {{-- Jenis Kelamin --}}
                  <div class="d-flex flex-row align-items-center mb-2">
                    ...
                    <div class="form-outline flex-fill mb-0">
                        <div><label class="form-label" for="form3Example6cd">Jenis Kelamin</label></div>
                         ...
                         <label class="form-check-label me-5" for="flexRadioDefault1">Laki-Laki</label>
                ...
                {{-- email --}}
                  <div class="d-flex flex-row align-items-center mb-2">
                    ...
                    <div class="border-bottom border-dark flex-fill mb-0 mt-lg-4">
                        ...
                        <input type="email" id="form3Example7c" class="form-control" name="email" value="{{old('email')}}"  required  />
                    </div>
                  </div>
                  {{-- Password --}}
